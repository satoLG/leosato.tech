...
<html lang="pt">
    ...
    <body>
        <div id="headerinfo">
            ...
            <div class="link_icons">
                ...
                <a href="https://github.com/satoLG/" class="icon" id="github" target="_blank" title="Github">
                    <svg xmlns="http://www.w3.org/2000/svg" height="23px" width="23px" fill="#000000" version="1.1" id="Layer_1" viewBox="-143 145 512 512" xml:space="preserve">
                        <g>
                ...
                <a href="https://codepen.io/satoLG/" class="icon" id="codepen" target="_blank" title="Codepen">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" width="30px" height="30px" viewBox="-2 -2 24 24" preserveAspectRatio="xMinYMin" class="jam jam-codepen-square">
        ...
        <script type="module" src="./js/under_construction_1.0.js">
        </script>  
